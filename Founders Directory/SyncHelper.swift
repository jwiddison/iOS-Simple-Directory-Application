...
//    
//    func clearUserDefaultsOnLogout() {
//        UserDefaults.standard.removeObject(forKey: Constants.sessionTokenKey)
...
class SyncHelper {
    ...
    private func syncDirtyFounders(_ serverMaxVersion: Int) -> Int {
        ...
        for dirtyId in FounderDatabase.shared.dirtyFounderIds() {
            ...
            let version = founderRow.value(named: Founder.Field.version)
            
            arguments[Parameter.version] = "\(version ?? 0)"
